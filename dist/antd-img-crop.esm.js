...
const EasyCrop = forwardRef((props, ref) => {
    ...
    return (jsxs(Fragment, { children: [jsx(Cropper, Object.assign({}, cropperProps, { cropSize: cropSize, ref: cropperRef, image: modalImage, crop: crop, 
                //
...
const ImgCrop = forwardRef((props, cropperRef) => {
    ...
    return (jsxs(Fragment, { children: [getNewUpload(children), modalImage && (jsx(AntModal, Object.assign({}, modalProps, modalBaseProps, { open: true, title: title, onCancel: onCancel.current, onOk: onOk.current, wrapClassName: wrapClassName, maskClosable: false, destroyOnClose: true, children: jsx(EasyCrop$1, { ratioX: ratioX, ratioY: ratioY, ref: easyCropRef, cropperRef: cropperRef, zoomSlider: zoomSlider, rotationSlider: rotationSlider, aspectSlider: aspectSlider, showReset: showReset, resetBtnText: resetBtnText, modalImage: modalImage, aspect: aspect, minZoom: minZoom, maxZoom: maxZoom, cropShape: cropShape, showGrid: showGrid, cropperProps: cropperProps }) })))] }));
});
